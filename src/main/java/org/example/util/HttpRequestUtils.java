...
public class HttpRequestUtils {
    ...
    /**
     * @param requestFirstLine: HTTP 헤더의 첫 번째 라인 e.g) GET /index.html HTTP/1.1
     */
    public static String getUrl(final String requestFirstLine) {
        String[] tokens = requestFirstLine.split(" ");
        String path = tokens[1]; // 공백으로 분리하면 두 번째 요소가 path url
